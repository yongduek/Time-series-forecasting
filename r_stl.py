...
'''
    source: https://gist.github.com/andreas-h/7808564

    This file seems to be old, and did not work during my trys with python3
'''
...
def stl(data, ns, np=None, nt=None, nl=None, isdeg=0, itdeg=1, ildeg=1,
    ...
    _idx = pandas.date_range(start=_data.index[0], end=_data.index[-1],
                            offset=pandas.tseries.offsets.MonthBegin())
...
if __name__ == "__main__":
    ...
    idx = pandas.date_range(start=datetime.datetime(1999,1,1),
                           ...
                           offset=pandas.tseries.offsets.MonthEnd())
